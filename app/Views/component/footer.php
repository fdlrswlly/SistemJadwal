<footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Roeswelly AF 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="<?php echo base_url('theme'); ?>/js/demo/chart-area-demo.js"></script>
    <script src="<?php echo base_url('theme'); ?>/js/demo/chart-pie-demo.js"></script>
